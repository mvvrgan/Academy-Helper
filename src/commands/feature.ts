...
import * as features from "../tools/utils/features";

const data = {
    name: 'feature',
    description: 'Feature your work to the community!',
}
    ...
    utils.permissions.check(interaction.member, data.name)
        .then(async () => {
            let Embed = new discord.MessageEmbed()
                ...
                .setDescription(`You are about to create a feature post, would you like to continue?`)
                .setTimestamp()
                .setColor('#4287f5')
